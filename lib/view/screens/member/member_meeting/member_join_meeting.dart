...
class MemberJoinMeeting extends StatefulWidget {
  @override
  State<MemberJoinMeeting> createState() => _MemberJoinMeetingState();
}

class _MemberJoinMeetingState extends State<MemberJoinMeeting> {
  int currentIndex = 0;
