...
class MemberMeeting extends StatefulWidget {
  @override
  State<MemberMeeting> createState() => _MemberMeetingState();
}

class _MemberMeetingState extends State<MemberMeeting> {
              ...
              child: Column(
                ...
                children: [
                  MyButton(
                    ...
                    onTap: () => Get.to(() => MemberJoinMeeting()),
                    textSize: 14,
                  ),
                  SizedBox(
                    height: 24,
