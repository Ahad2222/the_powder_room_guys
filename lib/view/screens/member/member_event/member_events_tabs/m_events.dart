...
import 'package:the_powder_room_guys/view/screens/member/member_event/member_event_detail.dart';
import 'package:the_powder_room_guys/view/widget/log_tile.dart';
import 'package:the_powder_room_guys/view/widget/my_text.dart';
import 'package:timelines/timelines.dart';


class MEvents extends StatelessWidget {
  @override
        ...
        FixedTimeline.tileBuilder(
          ...
          builder: TimelineTileBuilder(
            ...
            contentsBuilder: (_, index) {
              if (index == 0 || index == 1) {
                return TimeLineTile(
                  onTap: () => Get.to(() => MemberEventDetail()),
                  date: 'Oct 12',
