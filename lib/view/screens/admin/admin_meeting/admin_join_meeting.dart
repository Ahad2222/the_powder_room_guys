...
class AdminJoinMeeting extends StatefulWidget {
  @override
  State<AdminJoinMeeting> createState() => _AdminJoinMeetingState();
}

class _AdminJoinMeetingState extends State<AdminJoinMeeting> {
  int currentIndex = 1;
